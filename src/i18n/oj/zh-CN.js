export const m = {
  ...
  About_presentation_error_answer_part_1: '有无输出格式错误取决于具体的题目。如果题目支持输出格式错误，题目详情页上将有相应的陈述。Judger将自动对输出修整然后包裹在输出的',
  last: '最后',
  About_presentation_error_answer_part_2: '一行中。OJ会比较修整前的输出和标准输出。在结果不同时，如果题目不支持输出格式错误，算作答案正确，否则将会导致输出格式错误。如果修正后的输出与正确的输出不同，则结果将是',
