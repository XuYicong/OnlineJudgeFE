export const m = {
  ...
  About_presentation_error_answer_part_1: 'Some problems support presentation error while others do not. If a problem supports presentation error, you would notice corresponding declaration in the problem details page. In both cases, the judger will trim the blacks and wraps in your ouput\'s',
  last: 'last',
  About_presentation_error_answer_part_2: 'line. If presentation error is enabled and the untrimed user output is different with standard, a presentation error is emitted. If the trimmed user output is different with the correct output, the result will be',
