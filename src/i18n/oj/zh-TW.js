export const m = {
  ...
  About_presentation_error_answer_part_1: '有無輸出格式錯誤取決於具體的題目。如果題目支持輸出格式錯誤，題目詳情頁上將有相應的陳述。Judge系統將自動整理輸出然後包裹在輸出的',
  last: '最後',
  About_presentation_error_answer_part_2: '一行中。OJ會比較整理前的輸出和標準輸出。在結果不同時，如果題目不支持輸出格式錯誤，算作答案正確，否則將會導致輸出格式錯誤。如果整理後的輸出仍然與正確的輸出不同，則結果將是',
